...
class MeliVehicleAnalyzer:
    ...
    def take_screenshot(self, url, output_file="screenshot.png", width=1920, height=1080):
        """
        Toma una captura de pantalla de la página de listado de MELI sin esperar a que se carguen todos los recursos.
        ...
        try:
            with sync_playwright() as p:
                ...
                # Navegar a la página esperando 'domcontentloaded' en lugar de 'networkidle'
                page.goto(url, wait_until='domcontentloaded', timeout=10000)
                
                # Breve pausa para que se rendericen elementos básicos
                time.sleep(2)
                
                # Intentar esperar un selector específico (opcional)
                try:
